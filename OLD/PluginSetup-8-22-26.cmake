...
# ---------------------------------------------------------------------------
# Apply immediately after add_library

target_include_directories(${PACKAGE_NAME} PRIVATE
        ${OCPN_WXWIDGETS_INCLUDE_DIR}
        ${OCPN_WXWIDGETS_GL_INCLUDE_DIR}
  )

# MSVC often ignores global link_directories(), so we force it:
...
# if(MSVC)
    ...
    # wxWidgets lib directory from PluginSetup/PluginConfigure
    # Use full path to force MSVC to use the right wxWidgets import libraries.
    
target_link_libraries(${PACKAGE_NAME} PRIVATE
    ${OCPN_WXWIDGETS_LIB_DIR}/wxbase32u.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxbase32u_xml.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxexpat.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxjpeg.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxpng.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxzlib.lib

    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_core.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_adv.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_html.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_aui.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_xrc.lib
    ${OCPN_WXWIDGETS_LIB_DIR}/wxmsw32u_gl.lib
...
# ---------------------------------------------------------------------------
# Plugin include directory (for nlohmann/json.hpp and all plugin headers)
# Build-time include directory (required for generated version.h)
# ---------------------------------------------------------------------------
# Plugin include + build-time include
target_include_directories(${PACKAGE_NAME} PRIVATE
